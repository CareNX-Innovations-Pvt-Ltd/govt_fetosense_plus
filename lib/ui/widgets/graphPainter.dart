...
class GraphPainter extends CustomPainter {
  ...
  GraphPainter(this.test, this.mOffset, this.gridPerMin, {this.interpretations,this.displayFhr = 0});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    graphNoiseZone =  Paint()
      ...
      ..strokeWidth = pixelsPerOneMM * .30;
    graphBpmLine =  Paint()
      ..color = AppColors.us1// const Color.fromRGBO(0, 0Xf5, 0, 1.0)//00f500
      ..strokeWidth = pixelsPerOneMM * .30;
    graphBpmLine2 =  Paint()
      ..color = AppColors.us2//const Color.fromRGBO(0Xfa, 0xd4, 0x40, 1.0)//fad400
      ..strokeWidth = pixelsPerOneMM * .30;
    graphBpmLine3 =  Paint()
  ...
  drawGraph(Canvas canvas) {
    ...
    drawTocoLine(canvas,test.tocoEntries,graphBpmLine4);
    drawTocoLine(canvas,test.spo2Entries,graphBpmLine);
  ...
  void drawTocoLine(Canvas canvas,List<int> list, Paint lineStyle) {
    ...
    for (;
        i < list.length - 1 && i < (mOffset + pointsPerPage);
        i++) {
      startData = stopData;
      stopData = list[i];
