...
class StepPatientId extends StatefulWidget {
  final StepperAController controller;
  final Map<String, dynamic> mother;
  const StepPatientId({super.key, required this.controller, required this.mother});

  @override
  State createState() => _StepTwoState();
}

class _StepTwoState extends State<StepPatientId> {
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                obscureText: false,
                initialValue: widget.mother["patientId"],
                validator: (value) {
                  return null;
                },
                onSaved: (value){
                  widget.mother["patientId"] = value;
                },
