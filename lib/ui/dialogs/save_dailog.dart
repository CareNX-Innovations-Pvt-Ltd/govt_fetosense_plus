...
import 'package:l8fe/ui/dialogs/save/step_print.dart';
...
class SaveDialog extends StatefulWidget {
  final Null Function() onClosePressed;
  final Null Function() onPrintPressed;
  const SaveDialog({Key? key,required this.onClosePressed, required this.onPrintPressed}) : super(key: key);
  @override
...
class _DialogState extends State<SaveDialog> {
      ...
      child: SizedBox(
        ...
        child: IntrinsicHeight(
          child: StepperA(
            ...
            /*customSteps: const [
              CustomSteps(stepsIcon: FontAwesomeIcons.filePdf, title: "LogIn"),
            ...
            stepperBodyWidget: [
              ...
              StepPrintAsk(controller: controller,close:widget.onClosePressed,print:widget.onPrintPressed),
            ],
          ),
        ),
      ),
